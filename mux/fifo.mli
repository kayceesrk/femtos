(** FIFO scheduler for femtos - First-In-First-Out cooperative scheduling.
    ...
    The scheduler maintains a queue of runnable fibers and executes them in
    the order they were added to the queue. When a fiber yields or forks,
    control is transferred to the next fiber in the queue.
